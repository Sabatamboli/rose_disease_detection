...
MODEL_PATH = "rose_disease_prediction_model.keras"

if not os.path.exists(MODEL_PATH):
    print("Downloading model...")

    url = "https://huggingface.co/sabatamboli/rose-disease-model/resolve/main/rose_disease_prediction_model.keras"
